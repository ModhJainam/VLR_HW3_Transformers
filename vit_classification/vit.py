...
class ViT(nn.Module):
    ...
    def __init__(self, patch_dim, d_model, d_ff, num_heads, num_layers, num_patches, num_classes, device = 'cuda'):
        ...
        self.cls_token = nn.Parameter(torch.zeros(1, 1, self.d_model)) # TODO (learnable [CLS] token embedding)
    ...
    def patchify(self, images):
        ...
        images = images.reshape(images.shape[0], 3, self.num_patches, -1).transpose(1, 2)
